...
int main(void)
{
  ...
  while (1)
  {
    ...
    if(__HAL_TIM_GetCounter(&htim3) > 5)
    {
      ...
      buffComming = 0; 
      if(CRC_MODBUS(rx_data, rx_count) && rx_data[0]==0x02) ModbusTransHandle(); 
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : Input_Sensor_03_Pin Input_Sensor_02_Pin */
  GPIO_InitStruct.Pin = Input_Sensor_03_Pin|Input_Sensor_02_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : Input_Sensor_01_Pin */
  GPIO_InitStruct.Pin = Input_Sensor_01_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Input_Sensor_01_GPIO_Port, &GPIO_InitStruct);
